# Generated by Django 4.2.5 on 2025-04-21 22:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('wait', 'Ожидание'), ('rejected', 'Отколнена'), ('approved', 'Одобрена')], default='wait', max_length=9, verbose_name='Статус заявки')),
