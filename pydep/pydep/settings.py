...
SECRET_KEY = 'django-insecure-wj9zg(7hniron4bnmurb@7shm*v53@q)fbh@7df==qbrw4=1fg'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'lesson.context_processors.filters.prog_langs',
            ],
        },
    },
]
...
# CKEDITOR_5_CUSTOM_CSS = f'{BASE_DIR}/static/css/ckeditor.css}'  # optional
